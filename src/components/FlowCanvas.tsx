import ReactFlow, { Background, Controls, MiniMap, useEdges, useEdgesState, useNodesState, type Node, ConnectionLineType, addEdge, type Connection } from 'react-flow-renderer';
...
//Harshita add minimap and animated edges